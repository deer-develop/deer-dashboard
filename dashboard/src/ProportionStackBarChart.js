...
export default withTooltip(({ data, width, height, events = false, margin = defaultMargin, tooltipOpen, tooltipLeft, tooltipTop, tooltipData, hideTooltip, showTooltip, rowNumTicks = 5 }) => {
	// bounds
		...
		<div>
			<svg width={width} height={height}>
				...
				<Group top={margin.top} left={margin.left}>
					<BarStackHorizontal data={data} keys={keys} height={yMax} y={getDate} xScale={proportionScale} yScale={singleScale} color={colorScale}>
						{(barStacks) =>
					...
					<AxisLeft hideAxisLine hideTicks hideStroke scale={singleScale} />
					<AxisBottom
						top={yMax}
