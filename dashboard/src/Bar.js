...
function Bar() {
	...
	const hourFetcher = new Map([[1, [[npsIndicatorsRefetch], [npsDissatisfactionIndicatorsRefetch, () => setNpsButton('total')], [useDissatisfactionDetailsRefetch, () => setUseButton('total')]]]])
				...
				<Container>
					<div style={{ width: '320px', height: '215px' }}>
						<div style={{ float: 'left', width: `${(220 * 100) / BOX_13_W}`, height: '100%' }}>
							<ProportionBarChart data={useDissatisfactionDetails.top4UseDissatisfactionProportion} width={240} height={200} proportionMax={100} />
						</div>
