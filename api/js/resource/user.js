...
router.get('/activity-rate/indicators', async (req, res) => {
	const { coreUserActivityRate, coreUserActivityRateDayOnDay } = await metrics.getCoreUserActivityRateMetric()
	const { activeUserActivityRate, activeUserActivityRateDayOnDay } = await metrics.getActiveUserActivityRateMetric()
...
router.get('/activity-rate/history', async (req, res) => {
	const coreUserActivityRateHistory = await metrics.getCoreUserActivityRateHistoryMetric()
